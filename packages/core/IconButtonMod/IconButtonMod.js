...
var IconButtonMod = /*#__PURE__*/React.forwardRef(function IconButtonMod(props, ref) {
...
process.env.NODE_ENV !== "production" ? IconButtonMod.propTypes = {
  /**
   * The icon element.
   */
