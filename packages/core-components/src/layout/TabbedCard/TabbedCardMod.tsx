...
export type TabbedCardClassKeyMod = 'root' | 'indicator';
...
/** @public */
export type BoldHeaderClassKeyMod = 'root' | 'title' | 'subheader';
...
export function TabbedCardMod(props: PropsWithChildren<Props>) {
  const {
    slackChannel,
    errorBoundaryProps,
    children,
...
/** @public */
export type CardTabClassKeyMod = 'root' | 'selected';
 ...
 *
 */
export function CardTabMod(props: PropsWithChildren<CardTabProps>) {
