...
type MultiSignInPagePropsMod = SignInPageProps & {
  providers: IdentityProviders;
  title?: string;
  align?: 'center' | 'left';
};

type SingleSignInPagePropsMod = SignInPageProps & {
  provider: SignInProviderConfig;
  auto?: boolean;
};

export type Props = MultiSignInPagePropsMod | SingleSignInPagePropsMod;

export const MultiSignInPageMod = ({
  onSignInSuccess,
  providers = [],
  title,
  align = 'left',
}: MultiSignInPagePropsMod) => {
...
export const SingleSignInPageMod = ({
  provider,
  auto,
  onSignInSuccess,
}: SingleSignInPagePropsMod) => {
  const classes = useStyles();
...
export function SignInPageMod(props: Props) {
  if ('provider' in props) {
    return <SingleSignInPageMod {...props} />;
  }

  return <MultiSignInPageMod {...props} />;
}
