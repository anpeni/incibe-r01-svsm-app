...
/** @public */
export type SelectInputBaseClassKeyMod = 'root' | 'input';
...
/** @public */
export type SelectItemMod = {
  label: string;
  value: string | number;
};

/** @public */
export type SelectedItemsMod = string | string[] | number | number[];

export type SelectPropsMod = {
  multiple?: boolean;
  items: SelectItemMod[];
  label: string;
  placeholder?: string;
  selected?: SelectedItemsMod;
  onChange: (arg: SelectedItemsMod) => void;
...
/** @public */
export function SelectComponentMod(props: SelectPropsMod) {
  const {
    multiple,
    items,
    label,
  ...
  const [value, setValue] = useState<SelectedItemsMod>(
    selected || (multiple ? [] : ''),
  );
  ...
  const handleChange = (event: React.ChangeEvent<{ value: unknown }>) => {
    setValue(event.target.value as SelectedItemsMod);
    onChange(event.target.value as SelectedItemsMod);
  };
