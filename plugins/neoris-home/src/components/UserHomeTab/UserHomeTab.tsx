...
export const USER_HOME_TAB_KEY = LAYOUT_ROUTE_DATA_KEY;

/** @public @deprecated Use SettingsLayoutRouteProps instead */
export type UserHomeTabProps = PropsWithChildren<{
  /**
 ...
 */
export const UserHomeTab = (props: UserHomeTabProps) => (
  <HomeLayout.Route path={props.path} title={props.title} >
    <>props.children</>
  </HomeLayout.Route>
);

attachComponentData(UserHomeTab, USER_HOME_TAB_KEY, 'UserHomeTab');
