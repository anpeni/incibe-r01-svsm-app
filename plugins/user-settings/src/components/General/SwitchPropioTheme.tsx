...
export const MySwitchTheme: React.FC<MySwitchProps> = ({ checked, onChange, name }) => {
    ...
    return (
        <div onClick={handleClick} style={switchStyle as React.CSSProperties}>
          ...
          : <Brightness7Icon style={icono as React.CSSProperties}/>  // Icono para el estado "unchecked"
        }
            </div>
        </div>
    );
